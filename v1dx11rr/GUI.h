...
public:
	...
	bool InitScene(ID3D11Device* D3D11Device, ID3D11DeviceContext* D3DContext, LPCWSTR texturePath)
	{
		...
		// Set the texture
		D3DX11CreateShaderResourceViewFromFile(d3d11Device, texturePath, 0, 0, &Texture, 0);
	...
	void createBitMap()	 {
		...
		d3d11Device->CreateTexture2D(&textureDesc, NULL, &textureGUI);
	...
	void Draw(float posX, float posY) {
		...
		// Seteamos la matriz World a una escala y traslacion dada apara acomodarla en pantalla
		D3DXMATRIX Scale, Translation;
		D3DXMatrixScaling(&Scale, 1, 1, 1);
		D3DXMatrixTranslation(&Translation, posX, posY, 0.5);
